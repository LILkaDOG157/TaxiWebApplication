      ...
      <main className="pt-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
                Станьте водителем такси прямо сейчас
              </h1>
              <p className="text-xl text-white/90 leading-relaxed">
                Присоединяйтесь к нашей команде профессиональных водителей. 
                Высокий доход, гибкий график и поддержка 24/7.
              </p>
            ...
            <div className="relative h-[400px] hidden md:block">
              <div className="w-full h-full bg-white/10 rounded-lg flex items-center justify-center animate-float">
        ...
        <section className="bg-white/95 backdrop-blur-sm py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Преимущества работы с нами</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">Высокий доход</h3>
                <p className="text-gray-600">Стабильный заработок и бонусы за качественную работу</p>
              </div>
              <div className="card">
                <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">Гибкий график</h3>
                <p className="text-gray-600">Работайте когда удобно вам</p>
              </div>
              <div className="card">
                <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">Поддержка 24/7</h3>
                <p className="text-gray-600">Техническая поддержка и помощь на линии</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-yellow-500 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
              Регистрация занимает всего несколько минут. Присоединяйтесь к тысячам довольных водителей уже сегодня!
            </p>
            <Link href="/register" className="btn-primary">
